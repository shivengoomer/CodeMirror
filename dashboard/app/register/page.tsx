...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute bottom-[20%] right-[20%] w-[40%] h-[40%] bg-purple-500/10 rounded-full blur-[120px] animate-pulse-glow" />
      ...
      >
        <div className="flex flex-col items-center mb-10">
          <motion.div 
            ...
            className="w-16 h-16 rounded-2xl bg-purple-500/10 flex items-center justify-center border border-purple-500/30 shadow-[0_0_20px_-5px_rgba(168,85,247,0.4)] mb-6"
          >
        ...
        <PremiumCard glow className="p-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-mono font-bold text-foreground/30 uppercase tracking-widest ml-1">Access Key</label>
              <input
                type="password"
                value={password}
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-mono font-bold text-foreground/30 uppercase tracking-widest ml-1">LeetCode Handle (Optional)</label>
              <input
                type="text"
            ...
            >
              {loading ? "Initializing..." : (
                <>
                  Start Exploration <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                </>
              )}
            </motion.button>
          </form>
        ...
        <p className="mt-8 text-center text-[11px] text-foreground/30 font-mono uppercase tracking-[0.2em]">
          Already registered?{" "}
          <Link href="/login" className="text-accent hover:text-accent-foreground transition-colors font-bold">
            Sign In to Terminal
          </Link>
        </p>
      </motion.div>
