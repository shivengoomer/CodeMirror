...
class InterviewReadiness(Base):
    ...
    topics_covered: Mapped[list[str] | None] = mapped_column(ARRAY(String))
    topics_weak: Mapped[list[str] | None] = mapped_column(ARRAY(String))
    topics_strong: Mapped[list[str] | None] = mapped_column(ARRAY(String))
